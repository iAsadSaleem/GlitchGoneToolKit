/**
 * Generic Loader
 * Injects loader HTML dynamically and provides show/hide functions
 */
...
const Loader = (() => {
    ...
    div.innerHTML = `
      <svg class="pl" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle class="pl__ring" cx="100" cy="100" r="82" fill="none"
          stroke="url(#pl-grad1)" stroke-width="36"
          stroke-dasharray="0 257 1 257"
          stroke-linecap="round"
          transform="rotate(-90,100,100)" />
        <line class="pl__ball" stroke="url(#pl-grad2)"
  ...
  return {
    show: () => loaderEl.classList.remove("hidden"),
    hide: () => loaderEl.classList.add("hidden")
  };
})();
